...
import (
	...
	"crm-api/auth"
	"crm-api/auth/googleAuth"
	"crm-api/graphql/generated"
	"crm-api/internal/graphql/schema"
...
func Handler() {
	c := cors.New(cors.Options{
		AllowedOrigins:   []string{"https://your-frontend-on-netlify.app", "http://localhost:3000"}, // Allow frontend (Netlify & local)
	...
	mux.HandleFunc("/auth/{provider}/callback", googleAuth.OauthCallbackHandler)
	mux.HandleFunc("/auth/", func(w http.ResponseWriter, r *http.Request) {
